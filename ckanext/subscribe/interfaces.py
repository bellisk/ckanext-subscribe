...
from ckanext.subscribe.utils import \
    get_footer_contents as subscribe_get_footer_contents
from ckanext.subscribe.utils import \
    get_manage_email_contents as subscribe_get_manage_email_contents
from ckanext.subscribe.utils import \
    get_notification_email_contents as \
    subscribe_get_notification_email_contents
from ckanext.subscribe.utils import \
    get_subscription_confirmation_email_contents as \
    subscribe_get_subscription_confirmation_email_contents
from ckanext.subscribe.utils import \
    get_verification_email_contents as \
